...
<head>
  ...
  <title>Cerrar Bus | Express Bus Tickets</title>
...
<div id="mailto-window">
	<font size="4" color="#0099CC">
		CERRAR BUS	</font>
        <h4><Font color="#FF0000">¡ PRECAUSION NO CIERRE EL BUS A MENOS QUE ESTE  HAYA PARTIDO DE SU TERMINAL EL CAMBIO ES IRREVERSIBLE !</Font></h4><br />
        Una vez cerrado el bus usted prodra visualizarlo pero no podra efectuar ninguna operacion en el.
	...
	<form action="execute_selected_process.php" method="post">
		<div class="formelm">
			...
			<input type="text" name="bus"  id="f3" class="inputbox" size="10" maxlength="6"/>
        ...
        <input type="hidden" name="task" value="cb" />
