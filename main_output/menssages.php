...
check_active_user($con, $valid_user);
?>
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es-es" dir="ltr" lang="es-es"><head>
  ...
  <?php //verificamos si tine permiso
   is_authorized_mail($active_mail); ?>
   <?php  
   $limit=$_POST["limit"];
 ...
 <script>
			function redirect()
			{
				window.location.replace('menssages.php');
			}
...
<ul>
<a href="new_message.php" class="toolbar">
...
<li class="button" id="toolbar-new">
<a href="new_archive.php" class="toolbar">
...
<div class="clr"></div>
	...
	<fieldset id="filter-bar">
        ...
        <form action="menssages.php" method="post">
			<label class="filter-search-lbl" for="filter_search">Mensaje: </label>
			<input name="buscar" id="filter_search" title="Buscar en el asunto del mensaje o la descripción." type="text">
...
<font color="#0066FF"><b><?php echo $num_reg; ?></b></font>
        ...
        <form action="menssages.php" method="post">
			<select name="filtro" class="inputbox" onchange="this.form.submit()">
...
<option value="all">Todos</option>
    ...
    <form action="sis_men_ex.php" method="post" name="adminForm" id="adminForm">
	<div class="clr"> </div>
...
<div class="limit"><a href="menssages.php">Mostrar Todos: <img src="templates/images/admin/start-here-ubuntustudio.png" border="0" align="middle" /></a>
</div>
</div>
<div class="limit"></div>
</div>				</td>
		...
		view_all_men_users($con, $filtrar, $valid_user, $busqueda, $num_reg); 
	...
	<div>
		...
		<div class="clr"></div><?php echo $status_site; ?>
	</div>
	<div class="clr"></div>
</div>
</div>
