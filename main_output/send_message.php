...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es-es" dir="ltr" lang="es-es"><head>
  ...
  <title>Escribir nuevo mensaje | <?php default_title(); ?></title>
...
<a href="#" onclick="javascript:express.submitbutton('send')" class="toolbar">
...
<a href="#" onclick="popupWindow('../help/help_mail2.html', 'Ayuda', 900, 500, 1)" rel="help" class="toolbar">
...
<div class="clr"></div>
					...
					<div class="pagetitle icon-48-new-privatemessage"><h2>Escribir Mensaje Privado</h2></div>
				<div class="clr"></div>
			</div>
			<div class="b">
				<div class="b">
...
<form action="execute_mails.php" method="post" name="adminForm" id="message-form" class="form-validate">
	<div class="width-100">
...
recover_users_and_branch($con, $valid_user); 
echo '</select>';	
}
else{
echo '<div class="fltlft">
<input id="jform_user_id_to_name" name="ok" value='.$name.' type="text" readonly="readonly">
<input name="for_user" value='.$reply_id.' type="hidden">
</div>
</li>';
...
<li>
			...
			<li><label id="jform_message-lbl" for="jform_message" class="hasTip required" title="">Mensaje<span class="star">&nbsp;*</span></label>			<textarea name="message" id="jform_message" cols="80" rows="10" class="required" onkeypress="return permite(event, 'num_car')"></textarea></li>
		</ul>
		</fieldset>
