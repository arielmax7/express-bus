...
?>	
    ...
    <img src="../main_output/templates/images/header/notification_warning.png"><h4><Font color="#FF0000">¡ Sesión Finalizada Correctamente !</Font></h4>
    La sesión finalizada, cierre esta ventana.
    <br /><br />
